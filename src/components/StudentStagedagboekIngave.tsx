...
const StudentStagedagboekIngave = () => {
  ...
  const onSubmit = () => {
    try {
      toast.success(`Stagedagboek ingave successful.`);
    } catch (error) {
    ...
    <>
      <Breadcrumb className="m-4">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>Nieuwe ingave</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      <div className="mx-auto max-w-7xl px-4 py-6 md:py-12">
        <h1 className="mb-4 text-4xl font-bold">Nieuwe stagedag ingave</h1>
        ...
        <div className="m-4">
          <Form {...form} onSubmit={form.handleSubmit(onSubmit)}>
            ...
            />
            <Button type="submit" className="mt-4 w-full" onClick={onSubmit}>
              Verzenden
            </Button>
          </Form>
        </div>
